...
% Last Modified by GUIDE v2.5 02-Oct-2018 14:17:06
...
if(nIn < 5 || isempty(varargin{2}))
    %prompt user to select Combined Movie List objects
...
% % --- Executes on button press in aveInterval_label.
% function doPartition_Callback(hObject, eventdata, handles)
% % hObject    handle to aveInterval_label (see GCBO)
% % eventdata  reserved - to be defined in a future version of MATLAB
% % handles    structure with handles and user data (see GUIDATA)
% 
% % Hint: get(hObject,'Value') returns toggle state of aveInterval_label
...
function aveInterval_Callback(hObject, eventdata, handles)
% hObject    handle to aveInterval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of aveInterval as text
%        str2double(get(hObject,'String')) returns contents of aveInterval as a double


% --- Executes during object creation, after setting all properties.
function aveInterval_CreateFcn(hObject, eventdata, handles)
% hObject    handle to aveInterval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% handles.p.aveInterval_label = get(handles.aveInterval_label,'Value');
handles.p.doPartition = 0;
handles.p.start2zero = get(handles.start2zero,'Value');
handles.p.shiftPlotPositive = get(handles.shiftPlotPositive,'Value');
handles.p.aveInterval = str2double(get(handles.aveInterval,'String'));
