...
% and track number
% Edit Luciana de Oliveira, September 2017. Update the function for
% removing artifacts.
%
...
%%%%% Alteration LRO-2017/09/05 %%%%%%%%%%%
% As now I have modified the function for removing artifacts,
% the eventually removing need to be the first thing in the
% function
%% if requested, remove splits and merges that are most likely artifacts
        
if removePotArtifacts
    tracks = reformCompTracksRemoveArtifacts(tracks); %%%%%%%%%%%%%%%%%%%%%%% add thresM2S for threshold study
end
