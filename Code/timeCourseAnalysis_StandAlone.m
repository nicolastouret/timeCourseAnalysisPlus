...
%                         frames.
%                         Rows as above.
%                         Columns = mean, means of modes 1-3, stds of modes
%                         1-3, fractions of modes 1, 2 and >3, number of
%                         modes, normalized mean.
...
ampLabels = { ...
    ...
    'Mode 1 Mean (a.u.)', 'Mode 2 Mean (a.u.)', 'Mode 3 Mean (a.u.)', ... % 2, 3, 4
    'Mode 1 Std (a.u.)', 'Mode 2 Std (a.u.)', 'Mode 3 Std (a.u.)', ... %5, 6, 7
    'Mode 1 Fraction', 'Mode 2 Fraction', 'Modes > 2 Fraction', ... % 8, 9, 10
    'Number of Modes', 'Normalized Fluorescence Amplitude Overall (monomer units)' ... % 11, 12
    };
