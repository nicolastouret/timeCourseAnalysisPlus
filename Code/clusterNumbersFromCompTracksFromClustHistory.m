function [clusterStats,clusterStatsMotion,clusterStatsFollower] = ...
    clusterNumbersFromCompTracksFromClustHistory(clustHistoryMerged,...
...
%   Expanded by KJ in July 2019 to break down numbers by follower presence.
%
